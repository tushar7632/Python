...
# abc = "hell everyone kaise ho"
# print(abc)

# print("relationships are like birds if you hold tightly they die if you hold loosely")
# print("Helo WORLD")
# print("how are u")
# print(abc)


# a =int(input("enterany first number = "))
# print(type(a))
...
# # generate a random numbers between 1 and 10(inclusive) as the target number
# target_num, guess_num = random.randint(1,7),0

# # Start a loop that continues untill the gueseed no matches the target number
# while target_num != guess_num:
#     # prompt the user to input a number between 1 and 10 and convert it to an integer
#     guess_num = int(input('guess a number between 1 and 10 until to you get it right: '))
    
# # print a message indicating succesful guessing once the correct number  is gussed
# print('well guessed!')


# 4. Write a  Python program to construct the following pattern, using a nested for l
...
# 14. Wriste a Python program that accepts a string and calculates the number of digits and letters.
...
# ourNum = int(input("enter any number"))
# ourRange = range(1,11)
# for x in ourRange:
#     result = ourNum * x
...
# def fun():
#     print("Welcome to letslearncoding")
# fun()
# fun()
# fun()
...
# ab =abc(num1,num2)
# print("The value of num1 and num2 is = ",ab) #150
...
# According to Wikipedia : In number theory, a perfect number is a positive integer that is equal tothat is, the sum 
# of its positive divisors excluding the number itself (also known as its aliquot sum). Equivalently, a perfect number
...
# nested function  => function within function is known as nested function 
...
# anonymous function = A function which does not have names is known as anonymous function 
